...
public class Player2Gauge : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        this.maxLife = GameManager.instance.player2Life;
    }
    ...
    void Update()
    {
        ...
        if (GameManager.instance.player2Life == maxLife)
        {
        ...
        if (GameManager.instance.player2Life >= maxLife / 2 && GameManager.instance.player2Life < maxLife)
        {
            ...
            yellowGauge.gameObject.SetActive(false);
            redGauge.gameObject.SetActive(false);
            greenGauge.fillAmount = GameManager.instance.player2Life / maxLife * fill;
        }
        else if (GameManager.instance.player2Life < maxLife / 2 && GameManager.instance.player2Life >= maxLife / 4)
        {
            icon1.gameObject.SetActive(false);
            icon2.gameObject.SetActive(false);
            ...
            redGauge.gameObject.SetActive(false);
            yellowGauge.fillAmount = GameManager.instance.player2Life / maxLife * fill;
        }
        else if (GameManager.instance.player2Life < maxLife / 4)
        {
            icon1.gameObject.SetActive(false);
            icon2.gameObject.SetActive(false);
            icon3.gameObject.SetActive(false);
            ...
            redGauge.fillAmount = GameManager.instance.player2Life / maxLife * fill;
        }
    }
}
